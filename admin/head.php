        ...
        <div class="sheet">
            <div class="sheet-body">
                <div class="header">
                    ...
                    <div class="logo">
                      <h1 id="name-text" class="logo-name"><a href="aprincipal.php">Talleres Javier Velazquez</a></h1>
                     <BR><h2 id="slogan-text" class="logo-text">Pagina oficial</h2>
                    </div>
                </div>
                <div class="nav">
                	<div class="l"></div>
                	...
                	<ul class="menu">
                        ...
                        <li>
                			<a href="modificar.php"><span class="l"></span><span class="r"></span><span class="t">Cambiar cita</span></a>
                			
                		</li>
                        <li>
                			<a href="aconsultar.php"><span class="l"></span><span class="r"></span><span class="t">Consultar citas</span></a>
