...
INSERT INTO  `taller`.`CITA` (`N_CITA`, `MOTIVO`) VALUES
('1', 'CAMBIO DE NEUMATICOS'), ('2', 'CAMBIO DE ACEITE'), 
('3', 'CAMBIO DE PASTILLAS DE FRENO'), 
('4', 'CAMBIO DE PARACHOQUES'),
('5', 'LUNA FRONTAL'),
('6', 'LIMPIEZA DEL TUBO DE ESCAPE'),('7', 'CAMBIO LIQUIDO ANTI-CONGELANTE'),
('8', 'CAMBIO DE RETROVISOR'), ('9', 'CAMBIO DE PINTURA DEL COCHE'),
('10', 'CAMBIO DE LLANTAS'),('11', 'CAMBIO DE LIMPIA PARABRISAS');
